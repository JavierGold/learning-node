      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'You signed up!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"tourForm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tourForm = void 0;
...
var tourForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, duration, maxGroupSize, difficulty, price, summary, description) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Added tour!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function tourForm(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
...
var _tourForm = require("./tourForm");
...
var formTour = document.querySelector('.form--tourForm');
...
if (formTour) formTour.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
  ...
  (0, _tourForm.tourForm)(name, duration, maxGroupSize, difficulty, price, summary, description);
});
